...
class FlowerAdpater// data is passed into the constructor
internal constructor(private val context: Activity, private val mData: List<Flower>) :
    RecyclerView.Adapter<FlowerAdpater.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = mInflater.inflate(R.layout.item_flower, parent, false)
